...
class EncDecRNNTSPKBPEModel(EncDecRNNTModel, ASRBPEMixin):
    ...
    def __init__(self, cfg: DictConfig, trainer: Trainer = None):
        ...
        self.enc_spk_proj = torch.nn.Linear(self.cfg.model_defaults.enc_hidden + self.cfg.model_defaults.num_speakers, self.cfg.model_defaults.enc_hidden)
    ...
    def change_vocabulary(
        ...
        del self.joint
        self.joint = EncDecRNNTSPKBPEModel.from_config_dict(new_joint_config)

        decoder_config = self.decoder.to_config_dict()
        new_decoder_config = copy.deepcopy(decoder_config)
        new_decoder_config.vocab_size = len(vocabulary)
        del self.decoder
        self.decoder = EncDecRNNTSPKBPEModel.from_config_dict(new_decoder_config)
    ...
    #rewrite training_step to include speaker information
