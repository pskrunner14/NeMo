...
from nemo.collections.asr.models.hybrid_rnnt_ctc_bpe_query_diar_tgt_spk_models import EncDecHybridRNNTCTCQueryDiarTgtSpkBPEModel
...
@hydra_runner(
    config_path="../conf/conformer/hybrid_transducer_ctc/", config_name="fastconformer_hybrid_transducer_ctc_tgt_spk_bpe.yaml"
)
def main(cfg):
    ...
    asr_model = EncDecHybridRNNTCTCQueryDiarTgtSpkBPEModel(cfg=cfg.model, trainer=trainer)
