...
# Training the model
```sh
python speech_to_text_rnnt_tgt_spk_bpe.py \
...
from nemo.collections.asr.models.rnnt_tgt_spk_bpe_models import EncDecRNNTTgtSpkBPEModel
...
def main(cfg):
    ...
    asr_model = EncDecRNNTTgtSpkBPEModel(cfg=cfg.model, trainer=trainer)
